...
export function StickyGroupHeader({ className, children, ...props }: ComponentProps<"div">) {
  return (
    <div
      className={cn(
        "sticky-chrome-follow sticky top-[var(--chrome-h,0px)] z-30 flex h-[var(--sticky-l1)] items-center bg-bg px-2 font-serif text-sm tracking-[0.2em] text-gold-dim uppercase",
        className,
      )}
      {...props}
    >
...
export function StickyItemHeader({
  ...
  return (
    <div
      className={cn(
        "sticky-chrome-follow sticky z-20 bg-bg",
...
export function StickyLeafHeader({ className, children, ...props }: ComponentProps<"div">) {
  return (
    <div
      className={cn(
        "sticky-header-fade sticky-chrome-follow sticky top-[calc(var(--chrome-h,0px)+var(--sticky-l1)+var(--sticky-l2))] z-10 bg-bg",
        className,
      )}
      {...props}
    >
